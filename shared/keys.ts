 ...
 * 'default' (let the browser do it). Desktop: Enter sends, Shift/Ctrl/Cmd+Enter make a new line, and an
 * empty message makes Enter do nothing. Touch keyboards: Enter is a new line, the Send button sends.
 */
